...
(function () {
    ...
    $.Msg("");
})();
...
function calculate_draw_prop(champ_input, hero_counts_input, courier_level_input, size_cost_pool_input) {
    ...
    return [output, perc_color, hero_in_play];
}
...
var round_descriptions = {
    ...
    3 : '5 крипосов',
    10 : 'обосанные големы', 
    15 : 'волкопсы подзаборные',
    20 : 'мишки-пидоришки', 
    25 : 'пиздокрылы',
    30 : 'эйншейнты-хуероги',
    35 : 'черный властелин', 
    40 : 'тролли',
    45 : 'годень',
    50 : 'дядя рошан'
...
function OnBattleInfo(data) {
    ...
    if (cur_round in round_descriptions) {
        ...
        if (cur_round > 3 && data.type == 'prepare') {
            ...
            var effects;
            Game.EmitSound("announcer_announcer_intl2012_teamnameban_02", 500, 100, 1); // announcer_announcer_intl2012_teamnameban_02
...
function OnShowDrawCard(keys) {
    ...
    $.Schedule(0.75, function(){
        ...
        for(var i = 0; i < times; i++){
            ...
            for (var key in hero_dict) {
				if (hero_dict[key]['name'] == champ_name && isInArray(key, user_list) == true) {
					$.Msg("___вошли в color_change___");
					color_change = true;				  
				}
			}
            ...
            if (!find_dota_hud_element('panel_hero_draw_card_' + i).FindChild('rank_draw_card_' + i)) {
                ...
                if (DISPLAY_DRAW_PROB && DISPLAY_TIER) {
					if (color_change == true) {
						...
						$.Msg("___вошли в 1 иф___ champ_name: " + champ_name + ', user_list: ' + user_list);
					}
                    find_dota_hud_element('rank_draw_card_' + i).text = champ_tier + ' (' + hero_in_play + ' / ' + hero_perc_avail + '%)';	
                } else if (DISPLAY_DRAW_PROB) {
					if (color_change == true) {
						find_dota_hud_element('rank_draw_card_' + i).style.color = "red";
						$.Msg("___вошли в 2 иф___ champ_name: " + champ_name + ', user_list: ' + user_list);
					}
                    find_dota_hud_element('rank_draw_card_' + i).text = '(' + hero_in_play + ' / ' + hero_perc_avail + '%)';
                } else {
					if (color_change == true) {
						find_dota_hud_element('rank_draw_card_' + i).style.color = "red";
						$.Msg("___вошли в 3 иф___ champ_name: " + champ_name + ', user_list: ' + user_list);
					}
...
function UpdateXPGoldText() {
    ...
    if (previous_courier_xp_to_level != courier_xp_to_level) {
        ...
        find_dota_hud_element('minimap_container').FindChild('gold_text').text = courier_xp_to_level + ' опыта (' + Math.ceil(courier_xp_to_level/4)*5 + ' монет) до след. уровня';
    }
}
